...
var missingCmd = &cobra.Command{
	Use:   "missing [flags] <anime-dir>",
	Short: "Find missing episodes in the anime",
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("missing called")
	},
}
...
func init() {
	...
	// missingCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// missingCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
